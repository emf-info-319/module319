...
_De quel type doit être cette variable ?_
...
_De quel type doit être cette variable ?_
_Qu'utilisera votre programme pour stocker le résultat calculé de "est-il majeur" ?_
4. Trouvez ensuite comment faire en Java pour dire « SI monAge est plus grand que 20 ALORS `estMajeur` = vrai SINON `estMajeur` = faux »
...
8. Executez votre programme pas-à-pas et vérifiez qu’il fait bien exactement ce qui précède. Si ce n’est pas le cas, trouvez l’erreur et corrigez-là.
_Pas-à-pas ! Et pas le triangle « Run ». Voir le code s’executer pas par pas aide beaucoup à comprendre !_
